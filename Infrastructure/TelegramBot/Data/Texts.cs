namespace TelegramBot.Data
{
    public static class Texts
    {
        ...
        public static string NoRights { get; } = "Вы не обладаете правами для смены роли пользователя";
        public static string ChangeOfRole { get; } = "Роль выбранного пользователя изменена";
        public static string NonExistentUser { get; } = "Такого пользователя не существует";
    }
}
