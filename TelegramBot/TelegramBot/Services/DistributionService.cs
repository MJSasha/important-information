...
namespace TelegramBot.Services
{
    public static class DistributionService
    {
        ...
        public static async void DistributeMessages(object sender, MessageEventArgs e)
        {
            ...
            if (BusyUsersIdAndService.Keys.Contains(e.Message.Chat.Id)) await BusyUsersIdAndService[e.Message.Chat.Id].ProcessMessage(e.Message);
        }
        ...
        public static async void DistributeCallbacks(object sender, CallbackQueryEventArgs e)
        {
            ...
            if (BusyUsersIdAndService.Keys.Contains(e.CallbackQuery.Message.Chat.Id)) 
                await BusyUsersIdAndService[e.CallbackQuery.Message.Chat.Id].ProcessMessage(e.CallbackQuery.Message);
        }
    }
}
